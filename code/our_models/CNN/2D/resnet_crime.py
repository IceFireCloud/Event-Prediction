...
def one_grid(block_num):
    ...
    #2401*168*112 => 2401*168*256 => 2401*16*16*168
    resnet = keras.applications.ResNet50(include_top=False, weights=None, input_tensor=None, input_shape=(16,16,168), pooling=None, classes=1000)
   ...
   # print(test_y)
    ...
    filename_s = '../../results/2D_with_truth/initial_discretized_2_' + str(block_num) + '.csv'
