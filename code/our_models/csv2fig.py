...
filename_s = '/data/schin/Work/LA_crime/results/CNN/2019-01-29-17/block_' + str(121)# + '_train'
#filename_s = '/data/schin/Work/LA_crime/results/MLP/2018-12-11-18/block_' + str(121)

def draw(filename_s, single_file=False, draw_trend=False):
    if single_file:
        ...
        if draw_trend:
            ...
            avg = 0
            with open('/data/schin/Work/LA_crime/our_models/average', 'r') as f:
